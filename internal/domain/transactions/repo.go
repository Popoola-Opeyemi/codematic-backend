...
func (r *repository) ListTransactionsByUserID(ctx context.Context, userID string, limit, offset int) ([]*Transaction, error) {
...
func (r *repository) ListTransactionsByTenantID(ctx context.Context, tenantID string, limit, offset int) ([]*Transaction, error) {
...
func (r *repository) ListAllTransactions(ctx context.Context, limit, offset int) ([]*Transaction, error) {
...
func (r *repository) ListTransactionsByStatus(ctx context.Context, status string, limit, offset int) ([]*Transaction, error) {
